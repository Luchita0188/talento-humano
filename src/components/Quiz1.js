...
class Quiz1 extends Component {
  ...
  actividadHandle = (event) => {
    ...
    switch (typeQuestion) {
      ...
      case 'multiple':
        ...
        if ((this.state.countMultiple >= 2 & this.state.countMultiple - 1)) {
          document.getElementById('act-'+ this.state.question).classList.add('disabledSolid2');  
        }
  ...
  nextQuestion = () => {
    ...
    for (let i = 0; i < questions[this.state.question].options.length; i++) {
    ...
    return (
      <div className = 'Quiz c-9 '>
        ...
        <div className = { 'question d-Flex d-C j-E aI-S' } id = { 'question-' + this.state.question }>
          ...
          <button
            className = 'buttonQuiz mT-4 pT-05 pB-05 pL-1 pR-1 disabled'
            id = 'btnNextQuiz'
